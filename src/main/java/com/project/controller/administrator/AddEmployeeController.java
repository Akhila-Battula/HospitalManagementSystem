...
public class AddEmployeeController 
{
	...
	{	
		...
		{		
			...
			infoLog.logActivities("in AddEmployeeController-add: got= "+n1+" "+birthdate+" "+gender+" "+email+" "+mobileNo+" "+country+" "+state+" "+city+" "+a1+" "+role+" "+qualification+" "+specialization);
			        
			Employee e1= new Employee(null,n1,birthdate,gender,email,mobileNo,country,state,city,a1,role,qualification,specialization);
