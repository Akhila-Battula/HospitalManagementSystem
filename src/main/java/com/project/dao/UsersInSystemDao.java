...
public class UsersInSystemDao 
{
	...
	public List<Integer> getUsersInSystem()
	{
		try 
		{
			...
			/*
			 * infoLog.logActivities("doctors:" + doctors);
			 * infoLog.logActivities("patients:" + patients);
			 * infoLog.logActivities("employees:" + employees);
			 * infoLog.logActivities("total_opd_income:" + total_opd_income);
			 */
			...
			//infoLog.logActivities("arraylist:" + users_count);
			return users_count;
