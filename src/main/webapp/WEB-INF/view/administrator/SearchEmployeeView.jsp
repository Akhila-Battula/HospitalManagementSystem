	    ...
	    <div class="col-sm-*">
			...
			<div class="sidenav">
				...
				<div style="background-color: rgb(135, 206, 250);">&nbsp;&nbsp;&nbsp;
					<span style="background-color: rgb(135, 206, 250);" class="badge badge-pill badge-warning">&nbsp;&nbsp;<%= l.getRole().toUpperCase() %>&nbsp;&nbsp;</span><br/><br/>
					<b>Username:</b> <%= l.getUsername() %><br/><br/>
					<b>Id:</b> <%= l.getId() %><br/>
					<a href="editView.html">
			    	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="text-decoration:underline; color:white;">edit...</span>
			    	</a>
				</div>
				</a><br/>
			    ...
			    <p class="card-text">
			    	<form action="searchEmployeeById.html" method="post" >
						 <div class="form-group">
						 	...
						 	<input type="text" class="form-control" id="exampleInputEmail1" name="id" placeholder="00xxx"
